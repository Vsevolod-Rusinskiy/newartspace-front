...
const MODAL_CONTENT = `В марте Галерея открыта в марте, апреле, мае с пн по ср с 13:00-19:00, в чт с 13:00-18:00,
в пт с 13:00-17:30
и в другое время / день по предварительной договоренности `
